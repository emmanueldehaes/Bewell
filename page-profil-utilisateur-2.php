...
<div class="container_profil">
    ...
    <section class="userProfile_profil card">
        <div class="profile_profil">
            <figure><img src="<?php echo get_template_directory_uri(); ?>/assets/img/sophiepicture.jpg" alt="profile" width="250px" height="250px"></figure>
        </div>
    </section>
    ...
    <section class="work_skills_profil card_profil">
        ...
        <div class="work_profil">
            ...
            <div class="skills_profil">
                ...
                <ul>
                    <li>Groupe <div class="progress-bar" style="width: 80%;"></div>
                    </li>
                    <li>Personnel <div class="progress-bar" style="width: 60%;"></div>
                    </li>
                    <li>Musculation <div class="progress-bar" style="width: 75%;"></div>
                    </li>
                    <li>Yoga <div class="progress-bar" style="width: 90%;"></div>
                    </li>
                </ul>
            </div>
    </section>
    ...
    <section class="userDetails_profil card_profil">
        <div class="userName_profil">
            <h1 class="name_profil">Sophie Tiels</h1>
                            ...
                            <div class="card-body m-3">
                                <div class="row">
                                    <div class="col-lg-4 d-flex justify-content-center align-items-center mb-4 mb-lg-0">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo.jpg" class="rounded-circle img-fluid shadow-1 pictureavis" alt="woman avatar" />
                                    </div>
                                    <div class="col-lg-8">
